...
<div id="kohana_error">
				...
				<div id="<?php echo $args_id ?>" class="collapsed">
					...
					<?php foreach ($step['args'] as $name => $arg): ?>
						<tr>
							...
							<td><pre><?php echo Debug::pprint($arg) ?></pre></td>
						</tr>
					<?php endforeach ?>
					</table>
				</div>
	...
	<h2><a href="#<?php echo $env_id = $error_id.'environment' ?>" onclick="return koggle('<?php echo $env_id ?>')"><?php echo '环境变量'; ?></a></h2>
		...
		<div id="<?php echo $env_id ?>" class="collapsed">
			<table cellspacing="0">
				...
				<tr>
					...
					<td><pre><?php echo Debug::pprint($value) ?></pre></td>
				</tr>
				<?php endforeach ?>
			</table>
		</div>
